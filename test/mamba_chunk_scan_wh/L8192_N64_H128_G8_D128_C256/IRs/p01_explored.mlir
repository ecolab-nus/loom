                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %47 = loom.subview %arg1[%41, %42, %43, %44] [1, 1, 1, %20] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x64x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                          ...
                          %67 = loom.subview %arg4[%41, %63, %64, 0] [1, %20, 1, 128] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x8192x8x128xf16> to memref<?x128xf16, strided<[1024, 1], offset: ?>>
                          ...
                          %72 = loom.subview %arg5[%41, %43, %42, 0, %69] [1, 1, 1, 128, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32x64x128x128xf16> to memref<128x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %123 = loom.subview %arg0[%41, %43, %64, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x8x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                            ...
                            %128 = loom.subview %arg1[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %132 = loom.subview %arg2[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %69] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          ...
                          %110 = loom.subview %arg3[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          ...
                          %114 = loom.subview %arg7[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %66 = loom.subview %arg4[%41, %62, %63, 0] [1, %20, 1, 128] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x8192x8x128xf16> to memref<?x128xf16, strided<[1024, 1], offset: ?>>
                          ...
                          %71 = loom.subview %arg5[%41, %43, %42, 0, %68] [1, 1, 1, 128, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32x64x128x128xf16> to memref<128x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %121 = loom.alloc [%20, %120] on @L1 : memref<?x?xf16>
                            %122 = loom.semaphore_take %121 : memref<?x?xf16> -> memref<?x?xf16>
                            %123 = loom.subview %arg0[%41, %43, %63, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x8x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %68] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          ...
                          %108 = loom.semaphore_take %107 : memref<?x?xf16> -> memref<?x?xf16>
                          %109 = loom.init_tensor %108[%20, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                          %110 = loom.subview %arg3[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          ...
                          %113 = loom.sync ins(%112 : tensor<?x?xf16>) outs(%79 : tensor<?x?xf16>) -> tensor<?x?xf16>
                          loom.semaphore_give %108 : memref<?x?xf16>
                          %114 = loom.subview %arg7[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          %115 = loom.bufferize_to_memref %113 : tensor<?x?xf16> -> memref<?x?xf16>
