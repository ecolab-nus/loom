...
module attributes {loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 32 : index}, loom.tile_h = {is_reduction = false, upper_bound = 32 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 128 : index}} {
  func.func @_mamba_chunk_scan(%arg0: memref<2x32x4x256x256xf16>, %arg1: memref<2x32x32x256xf16>, %arg2: memref<2x32x32x256xf16>, %arg3: memref<2x8192x32x128xf16>, %arg4: memref<2x8192x4x128xf16>, %arg5: memref<2x32x32x128x128xf16>, %arg6: memref<32xf16>, %arg7: memref<2x8192x32x128xf16>) {
    ...
    %3 = "loom.sym"() {is_reduction = false, symbol_ref = @tile_h, upper_bound = 32 : index} : () -> index
    %4 = "loom.sym"() {is_reduction = false, symbol_ref = @tile_b, upper_bound = 2 : index} : () -> index
    %5 = "loom.sym"() {is_reduction = false, symbol_ref = @tile_c, upper_bound = 32 : index} : () -> index
    %6 = arith.ceildivui %c32, %3 : index
    ...
    affine.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (0, 0, 0, 0, 0) to (symbol(%6), symbol(%7), symbol(%8), symbol(%9), symbol(%10)) {
      ...
      %subview = memref.subview %arg1[%13, %14, %15, %16] [1, 1, 1, %0] [1, 1, 1, 1] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
      ...
      %23 = arith.divui %14, %c8 : index
      %subview_0 = memref.subview %arg4[%13, %22, %23, 0] [1, %0, 1, 128] [1, 1, 1, 1] : memref<2x8192x4x128xf16> to memref<?x128xf16, strided<[512, 1], offset: ?>>
      %24 = bufferization.to_tensor %subview_0 : memref<?x128xf16, strided<[512, 1], offset: ?>> to tensor<?x128xf16>
      %25 = arith.muli %arg10, %1 : index
      %subview_1 = memref.subview %arg5[%13, %15, %14, 0, %25] [1, 1, 1, 128, %1] [1, 1, 1, 1, 1] : memref<2x32x32x128x128xf16> to memref<128x?xf16, strided<[128, 1], offset: ?>>
      ...
      %32 = scf.for %arg13 = %c0 to %31 step %c1 iter_args(%arg14 = %28) -> (tensor<?x?xf16>) {
        ...
        %subview_5 = memref.subview %arg0[%13, %15, %23, %16, %38] [1, 1, 1, %0, %42] [1, 1, 1, 1, 1] : memref<2x32x4x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
        %43 = bufferization.to_tensor %subview_5 : memref<?x?xf16, strided<[256, 1], offset: ?>> to tensor<?x?xf16>
        %subview_6 = memref.subview %arg1[%13, %14, %15, %38] [1, 1, 1, %42] [1, 1, 1, 1] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %subview_7 = memref.subview %arg2[%13, %14, %15, %38] [1, 1, 1, %42] [1, 1, 1, 1] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %subview_8 = memref.subview %arg3[%13, %55, %14, %25] [1, %2, 1, %1] [1, 1, 1, 1] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
        %56 = bufferization.to_tensor %subview_8 : memref<?x?xf16, strided<[4096, 1], offset: ?>> to tensor<?x?xf16>
        %57 = linalg.matmul ins(%54, %56 : tensor<?x?xf16>, tensor<?x?xf16>) outs(%arg14 : tensor<?x?xf16>) -> tensor<?x?xf16>
        scf.yield %57 : tensor<?x?xf16>
      }
      %subview_2 = memref.subview %arg6[%14] [1] [1] : memref<32xf16> to memref<f16, strided<[], offset: ?>>
      %33 = bufferization.to_tensor %subview_2 : memref<f16, strided<[], offset: ?>> to tensor<f16>
      %subview_3 = memref.subview %arg3[%13, %22, %14, %25] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
      ...
      %subview_4 = memref.subview %arg7[%13, %22, %14, %25] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
