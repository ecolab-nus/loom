module attributes {loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 32 : index}, loom.tile_h = {is_reduction = false, upper_bound = 32 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 128 : index}} {
  ...
  module attributes {loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 32 : index}, loom.tile_h = {is_reduction = false, upper_bound = 32 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 128 : index}} {
    func.func @_mamba_chunk_scan__x2x4_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_n_n_n_n_dim_x_level1_bc8_dim_y_level1_bc4_n_n(%arg0: memref<2x32x4x256x256xf16>, %arg1: memref<2x32x32x256xf16>, %arg2: memref<2x32x32x256xf16>, %arg3: memref<2x8192x32x128xf16>, %arg4: memref<2x8192x4x128xf16>, %arg5: memref<2x32x32x128x128xf16>, %arg6: memref<32xf16>, %arg7: memref<2x8192x32x128xf16>) {
      ...
      %23 = loom.sym @tile_h {upper_bound = 32 : index} : index
      %24 = loom.sym @tile_b {upper_bound = 2 : index} : index
      %25 = loom.sym @tile_c {upper_bound = 32 : index} : index
      %26 = arith.ceildivui %c32, %23 : index
      %27 = arith.ceildivui %c256, %20 : index
      %28 = arith.ceildivui %c128, %21 : index
      %29 = arith.ceildivui %c2, %24 : index
      %30 = arith.ceildivui %c32, %25 : index
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %47 = loom.subview %arg1[%41, %42, %43, %44] [1, 1, 1, %20] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                          ...
                          %64 = arith.divui %42, %c8 : index
                          %65 = loom.alloc [%20, 128] on @L1 : memref<?x128xf16>
                          %66 = loom.semaphore_take %65 : memref<?x128xf16> -> memref<?x128xf16>
                          %67 = loom.subview %arg4[%41, %63, %64, 0] [1, %20, 1, 128] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x8192x4x128xf16> to memref<?x128xf16, strided<[512, 1], offset: ?>>
                          loom.copy %67, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%49, %52], LR : [%49, %54]) : memref<?x128xf16, strided<[512, 1], offset: ?>> to memref<?x128xf16>
                          ...
                          %72 = loom.subview %arg5[%41, %43, %42, 0, %69] [1, 1, 1, 128, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32x32x128x128xf16> to memref<128x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %123 = loom.subview %arg0[%41, %43, %64, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x4x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                            ...
                            %128 = loom.subview %arg1[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %132 = loom.subview %arg2[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x32x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %69] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                            loom.copy %137, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16>
                          ...
                          %104 = loom.subview %arg6[%42] [1] [1], reuse : [seq = false, spat = true, temp = true] : memref<32xf16> to memref<f16, strided<[], offset: ?>>
                          ...
                          %110 = loom.subview %arg3[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                          loom.copy %110, %108 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16>
                          ...
                          %114 = loom.subview %arg7[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                          %115 = loom.bufferize_to_memref %113 : tensor<?x?xf16> -> memref<?x?xf16>
                          loom.copy %115, %114 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %63 = arith.divui %42, %c8 : index
                          %64 = loom.alloc [%20, 128] on @L1 : memref<?x128xf16>
                          %65 = loom.semaphore_take %64 : memref<?x128xf16> -> memref<?x128xf16>
                          %66 = loom.subview %arg4[%41, %62, %63, 0] [1, %20, 1, 128] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x8192x4x128xf16> to memref<?x128xf16, strided<[512, 1], offset: ?>>
                          loom.copy %66, %65 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%51, %52], LR : [%51, %53]) : memref<?x128xf16, strided<[512, 1], offset: ?>> to memref<?x128xf16>
                          ...
                          %71 = loom.subview %arg5[%41, %43, %42, 0, %68] [1, 1, 1, 128, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32x32x128x128xf16> to memref<128x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %121 = loom.alloc [%20, %120] on @L1 : memref<?x?xf16>
                            %122 = loom.semaphore_take %121 : memref<?x?xf16> -> memref<?x?xf16>
                            %123 = loom.subview %arg0[%41, %43, %63, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32x4x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %68] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                            loom.copy %137, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16>
                            %138 = loom.bufferize_to_tensor %100[%22, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                            %139 = linalg.matmul ins(%135, %138 : tensor<?x?xf16>, tensor<?x?xf16>) outs(%arg19 : tensor<?x?xf16>) -> tensor<?x?xf16>
                            loom.semaphore_give %100 : memref<?x?xf16>
                            loom.semaphore_give %97 : memref<?x?xf16>
                          ...
                          %108 = loom.semaphore_take %107 : memref<?x?xf16> -> memref<?x?xf16>
                          %109 = loom.init_tensor %108[%20, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                          %110 = loom.subview %arg3[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                          loom.copy %110, %108 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16>
                          %111 = loom.bufferize_to_tensor %108[%20, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                          %112 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%101, %111, %106 : tensor<?x?xf16>, tensor<?x?xf16>, tensor<f16>) outs(%109 : tensor<?x?xf16>) {
                          ^bb0(%in: f16, %in_0: f16, %in_1: f16, %out: f16):
                            %116 = arith.mulf %in_0, %in_1 : f16
                          ...
                          %113 = loom.sync ins(%112 : tensor<?x?xf16>) outs(%79 : tensor<?x?xf16>) -> tensor<?x?xf16>
                          loom.semaphore_give %108 : memref<?x?xf16>
                          %114 = loom.subview %arg7[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8192x32x128xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                          %115 = loom.bufferize_to_memref %113 : tensor<?x?xf16> -> memref<?x?xf16>
                          loom.copy %115, %114 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                          loom.semaphore_give %78 : memref<?x?xf16>
                        } {loom.block_sym = @tile_c, loom.iter_type = #loom.iter_type<temporal>}
                      } {loom.block_sym = @tile_b, loom.iter_type = #loom.iter_type<temporal>}
                    } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %65 = loom.semaphore_take %64 : memref<?x128xf16> -> memref<?x128xf16>
                          %66 = loom.subview %arg4[%41, %62, %63, 0] [1, %20, 1, 128] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x8192x4x128xf16> to memref<?x128xf16, strided<[512, 1], offset: ?>>
                          loom.copy %66, %65 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 4] region : (UL : [%51, %52], LR : [%51, %53]) : memref<?x128xf16, strided<[512, 1], offset: ?>> to memref<?x128xf16>
                          %67 = loom.bufferize_to_tensor %65[%20, 128] : memref<?x128xf16> -> tensor<?x128xf16>
                          %68 = arith.muli %38, %21 : index
                          %69 = loom.alloc [128, %21] on @L1 : memref<128x?xf16>
                          %70 = loom.semaphore_take %69 : memref<128x?xf16> -> memref<128x?xf16>
