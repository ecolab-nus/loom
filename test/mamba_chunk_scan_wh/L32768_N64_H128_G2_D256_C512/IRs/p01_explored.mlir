                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %47 = loom.subview %arg1[%41, %42, %43, %44] [1, 1, 1, %20] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
                          ...
                          %64 = arith.divui %42, %c32 : index
                          %65 = loom.alloc [%20, 256] on @L1 : memref<?x256xf16>
                          %66 = loom.semaphore_take %65 : memref<?x256xf16> -> memref<?x256xf16>
                          %67 = loom.subview %arg4[%41, %63, %64, 0] [1, %20, 1, 256] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32768x2x256xf16> to memref<?x256xf16, strided<[512, 1], offset: ?>>
                          loom.copy %67, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%49, %52], LR : [%49, %54]) : memref<?x256xf16, strided<[512, 1], offset: ?>> to memref<?x256xf16>
                          ...
                          %72 = loom.subview %arg5[%41, %43, %42, 0, %69] [1, 1, 1, 256, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x64x64x256x128xf16> to memref<256x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %123 = loom.subview %arg0[%41, %43, %64, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x2x512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                            ...
                            %128 = loom.subview %arg1[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %132 = loom.subview %arg2[%41, %42, %43, %116] [1, 1, 1, %120] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %69] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                            loom.copy %137, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16, strided<[8192, 1], offset: ?>> to memref<?x?xf16>
                          ...
                          %104 = loom.subview %arg6[%42] [1] [1], reuse : [seq = false, spat = true, temp = true] : memref<64xf16> to memref<f16, strided<[], offset: ?>>
                          ...
                          %110 = loom.subview %arg3[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          loom.copy %110, %108 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16, strided<[8192, 1], offset: ?>> to memref<?x?xf16>
                          ...
                          %114 = loom.subview %arg7[%41, %63, %42, %69] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          %115 = loom.bufferize_to_memref %113 : tensor<?x?xf16> -> memref<?x?xf16>
                          loom.copy %115, %114 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%49, %75], LR : [%49, %75]) : memref<?x?xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %63 = arith.divui %42, %c32 : index
                          %64 = loom.alloc [%20, 256] on @L1 : memref<?x256xf16>
                          %65 = loom.semaphore_take %64 : memref<?x256xf16> -> memref<?x256xf16>
                          %66 = loom.subview %arg4[%41, %62, %63, 0] [1, %20, 1, 256] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32768x2x256xf16> to memref<?x256xf16, strided<[512, 1], offset: ?>>
                          loom.copy %66, %65 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%51, %52], LR : [%51, %53]) : memref<?x256xf16, strided<[512, 1], offset: ?>> to memref<?x256xf16>
                          ...
                          %71 = loom.subview %arg5[%41, %43, %42, 0, %68] [1, 1, 1, 256, %21] [1, 1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x64x64x256x128xf16> to memref<256x?xf16, strided<[128, 1], offset: ?>>
                          ...
                          %101 = scf.for %arg18 = %c0 to %89 step %c1 iter_args(%arg19 = %86) -> (tensor<?x?xf16>) {
                            ...
                            %121 = loom.alloc [%20, %120] on @L1 : memref<?x?xf16>
                            %122 = loom.semaphore_take %121 : memref<?x?xf16> -> memref<?x?xf16>
                            %123 = loom.subview %arg0[%41, %43, %63, %44, %116] [1, 1, 1, %20, %120] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x64x2x512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                            ...
                            %137 = loom.subview %arg3[%41, %136, %42, %68] [1, %22, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = true] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                            loom.copy %137, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16, strided<[8192, 1], offset: ?>> to memref<?x?xf16>
                            %138 = loom.bufferize_to_tensor %100[%22, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                            %139 = linalg.matmul ins(%135, %138 : tensor<?x?xf16>, tensor<?x?xf16>) outs(%arg19 : tensor<?x?xf16>) -> tensor<?x?xf16>
                            loom.semaphore_give %100 : memref<?x?xf16>
                            loom.semaphore_give %97 : memref<?x?xf16>
                          ...
                          %108 = loom.semaphore_take %107 : memref<?x?xf16> -> memref<?x?xf16>
                          %109 = loom.init_tensor %108[%20, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                          %110 = loom.subview %arg3[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          loom.copy %110, %108 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16, strided<[8192, 1], offset: ?>> to memref<?x?xf16>
                          %111 = loom.bufferize_to_tensor %108[%20, %21] : memref<?x?xf16> -> tensor<?x?xf16>
                          %112 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%101, %111, %106 : tensor<?x?xf16>, tensor<?x?xf16>, tensor<f16>) outs(%109 : tensor<?x?xf16>) {
                          ^bb0(%in: f16, %in_0: f16, %in_1: f16, %out: f16):
                            %116 = arith.mulf %in_0, %in_1 : f16
                          ...
                          %113 = loom.sync ins(%112 : tensor<?x?xf16>) outs(%79 : tensor<?x?xf16>) -> tensor<?x?xf16>
                          loom.semaphore_give %108 : memref<?x?xf16>
                          %114 = loom.subview %arg7[%41, %62, %42, %68] [1, %20, 1, %21] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          %115 = loom.bufferize_to_memref %113 : tensor<?x?xf16> -> memref<?x?xf16>
                          loom.copy %115, %114 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%51, %75], LR : [%51, %75]) : memref<?x?xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
                          loom.semaphore_give %78 : memref<?x?xf16>
                        } {loom.block_sym = @tile_c, loom.iter_type = #loom.iter_type<temporal>}
                      } {loom.block_sym = @tile_b, loom.iter_type = #loom.iter_type<temporal>}
                    } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
                    ...
                    scf.for %arg15 = %c0 to %33 step %c1 {
                      ...
                      scf.for %arg16 = %c0 to %34 step %c1 {
                        ...
                        scf.for %arg17 = %c0 to %35 step %c1 {
                          ...
                          %65 = loom.semaphore_take %64 : memref<?x256xf16> -> memref<?x256xf16>
                          %66 = loom.subview %arg4[%41, %62, %63, 0] [1, %20, 1, 256] [1, 1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<2x32768x2x256xf16> to memref<?x256xf16, strided<[512, 1], offset: ?>>
                          loom.copy %66, %65 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 4] region : (UL : [%51, %52], LR : [%51, %53]) : memref<?x256xf16, strided<[512, 1], offset: ?>> to memref<?x256xf16>
                          %67 = loom.bufferize_to_tensor %65[%20, 256] : memref<?x256xf16> -> tensor<?x256xf16>
                          %68 = arith.muli %38, %21 : index
                          %69 = loom.alloc [256, %21] on @L1 : memref<256x?xf16>
                          %70 = loom.semaphore_take %69 : memref<256x?xf16> -> memref<256x?xf16>
