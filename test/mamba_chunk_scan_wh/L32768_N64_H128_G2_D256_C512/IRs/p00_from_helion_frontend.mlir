...
module attributes {loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 64 : index}, loom.tile_h = {is_reduction = false, upper_bound = 64 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 128 : index}} {
  func.func @_mamba_chunk_scan(%arg0: memref<2x64x2x512x512xf16>, %arg1: memref<2x64x64x512xf16>, %arg2: memref<2x64x64x512xf16>, %arg3: memref<2x32768x64x128xf16>, %arg4: memref<2x32768x2x256xf16>, %arg5: memref<2x64x64x256x128xf16>, %arg6: memref<64xf16>, %arg7: memref<2x32768x64x128xf16>) {
    ...
    affine.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (0, 0, 0, 0, 0) to (symbol(%6), symbol(%7), symbol(%8), symbol(%9), symbol(%10)) {
      ...
      %subview = memref.subview %arg1[%13, %14, %15, %16] [1, 1, 1, %0] [1, 1, 1, 1] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
      ...
      %23 = arith.divui %14, %c32 : index
      %subview_0 = memref.subview %arg4[%13, %22, %23, 0] [1, %0, 1, 256] [1, 1, 1, 1] : memref<2x32768x2x256xf16> to memref<?x256xf16, strided<[512, 1], offset: ?>>
      %24 = bufferization.to_tensor %subview_0 : memref<?x256xf16, strided<[512, 1], offset: ?>> to tensor<?x256xf16>
      %25 = arith.muli %arg10, %1 : index
      %subview_1 = memref.subview %arg5[%13, %15, %14, 0, %25] [1, 1, 1, 256, %1] [1, 1, 1, 1, 1] : memref<2x64x64x256x128xf16> to memref<256x?xf16, strided<[128, 1], offset: ?>>
      ...
      %32 = scf.for %arg13 = %c0 to %31 step %c1 iter_args(%arg14 = %28) -> (tensor<?x?xf16>) {
        ...
        %subview_5 = memref.subview %arg0[%13, %15, %23, %16, %38] [1, 1, 1, %0, %42] [1, 1, 1, 1, 1] : memref<2x64x2x512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
        %43 = bufferization.to_tensor %subview_5 : memref<?x?xf16, strided<[512, 1], offset: ?>> to tensor<?x?xf16>
        %subview_6 = memref.subview %arg1[%13, %14, %15, %38] [1, 1, 1, %42] [1, 1, 1, 1] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %subview_7 = memref.subview %arg2[%13, %14, %15, %38] [1, 1, 1, %42] [1, 1, 1, 1] : memref<2x64x64x512xf16> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %subview_8 = memref.subview %arg3[%13, %55, %14, %25] [1, %2, 1, %1] [1, 1, 1, 1] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
        %56 = bufferization.to_tensor %subview_8 : memref<?x?xf16, strided<[8192, 1], offset: ?>> to tensor<?x?xf16>
      ...
      %subview_3 = memref.subview %arg3[%13, %22, %14, %25] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
      %34 = bufferization.to_tensor %subview_3 : memref<?x?xf16, strided<[8192, 1], offset: ?>> to tensor<?x?xf16>
      ...
      %subview_4 = memref.subview %arg7[%13, %22, %14, %25] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x32768x64x128xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
      %37 = bufferization.to_buffer %36 : tensor<?x?xf16> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
      memref.copy %37, %subview_4 : memref<?x?xf16, strided<[8192, 1], offset: ?>> to memref<?x?xf16, strided<[8192, 1], offset: ?>>
    }
    return
  }
}
