  ...
  func.func @_matmul(%arg0: memref<4096x256xf16>, %arg1: memref<256x4096xf16>, %arg2: memref<4096x4096xf16>) {
    ...
    affine.parallel (%arg3, %arg4) = (0, 0) to (4096 ceildiv symbol(%0), 4096 ceildiv symbol(%1)) {
      ...
      %5 = affine.for %arg5 = 0 to #map()[%2] iter_args(%arg6 = %4) -> (tensor<?x?xf16>) {
        ...
        %subview_0 = memref.subview %arg0[%9, %10] [%0, %2] [1, 1] : memref<4096x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
        %11 = bufferization.to_tensor %subview_0 : memref<?x?xf16, strided<[256, 1], offset: ?>> to tensor<?x?xf16>
        %12 = arith.muli %arg4, %1 : index
        %subview_1 = memref.subview %arg1[%10, %12] [%2, %1] [1, 1] : memref<256x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
