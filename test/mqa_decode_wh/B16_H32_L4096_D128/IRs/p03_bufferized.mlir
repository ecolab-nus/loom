module attributes {loom.tile_b = {is_reduction = false, upper_bound = 8 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}, loom.tile_s = {is_reduction = false, upper_bound = 4096 : index}} {
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_b = {is_reduction = false, upper_bound = 8 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}, loom.tile_s = {is_reduction = false, upper_bound = 4096 : index}} {
    func.func @_mqa_decode__x8_y8__d0i1_d1i0__f01__dim_x_level0_bc8_n_n_n__is_double_buffer1__tile_b1__tile_n512__tile_s512(%arg0: memref<8x128x4096xf16>, %arg1: memref<8x4096x128xf16>, %arg2: memref<8x32x128xf16>, %arg3: memref<8x32x128xf16>) {
      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        ...
        %22 = loom.semaphore_take %20 : memref<1x32x128xf16> -> memref<1x32x128xf16>
        %23 = loom.semaphore_take %20 : memref<1x32x128xf16> -> memref<1x32x128xf16>
        %24 = arith.muli %arg4, %c4096 overflow<nsw> : index
        %reinterpret_cast = memref.reinterpret_cast %arg3 to offset: [%24], sizes: [1, 32, 128], strides: [4096, 128, 1] : memref<8x32x128xf16> to memref<1x32x128xf16, strided<[4096, 128, 1], offset: ?>>
        loom.copy %reinterpret_cast, %23 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [8, 1] region : (UL : [%c0, %arg4], LR : [%c7, %arg4]) : memref<1x32x128xf16, strided<[4096, 128, 1], offset: ?>> to memref<1x32x128xf16>
        ...
        %29 = loom.semaphore_take %26 : memref<1x32x128xf16> -> memref<1x32x128xf16>
        ...
        loom.batch_matmul ins(%23, %47 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%49 : memref<1x32x512xf16>)
        ...
        %59 = loom.broadcast ins(%45 : memref<1x32x1xf16>) outs(%52 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
        ...
        loom.batch_matmul ins(%49, %55 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%39 : memref<1x32x128xf16>)
        loom.semaphore_give %55 : memref<1x512x128xf16>
        loom.semaphore_give %49 : memref<1x32x512xf16>
        linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%39, %29, %59 : memref<1x32x128xf16>, memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%29 : memref<1x32x128xf16>) {
        ^bb0(%in: f16, %in_5: f16, %in_6: f16, %out: f16):
        ...
        %62 = loom.broadcast ins(%34 : memref<1x32x1xf16>) outs(%51 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
        loom.semaphore_give %34 : memref<1x32x1xf16>
        linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%29, %62 : memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%22 : memref<1x32x128xf16>) {
        ^bb0(%in: f16, %in_5: f16, %out: f16):
        ...
        loom.sync ins(%22 : memref<1x32x128xf16>) outs(%28 : memref<1x32x128xf16>)
        loom.semaphore_give %22 : memref<1x32x128xf16>
        %65 = loom.alloc [8, 1, 32, 128] on @L1 : memref<8x1x32x128xf16>
        %66 = loom.semaphore_take %65 : memref<8x1x32x128xf16> -> memref<8x1x32x128xf16>
        loom.gather ins(%28 : memref<1x32x128xf16>) outs(%66 : memref<8x1x32x128xf16>) across(%arg5 : index) region : (UL : [%c0, %arg4], LR : [%c7, %arg4])
        ...
        scf.if %73 {
          ...
          %74 = loom.broadcast ins(%68 : memref<8x1x32x1xf16>) outs(%72 : memref<8x1x32x32xf16>) dim(3) -> memref<8x1x32x128xf16, strided<[?, ?, ?, ?], offset: ?>>
          loom.semaphore_give %68 : memref<8x1x32x1xf16>
          loom.sync ins(%66 : memref<8x1x32x128xf16>) outs(%70 : memref<8x1x32x128xf16>)
          loom.semaphore_give %66 : memref<8x1x32x128xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%70, %74 : memref<8x1x32x128xf16>, memref<8x1x32x128xf16, strided<[?, ?, ?, ?], offset: ?>>) outs(%70 : memref<8x1x32x128xf16>) {
          ^bb0(%in: f16, %in_6: f16, %out: f16):
            %75 = arith.mulf %in, %in_6 : f16
            linalg.yield %75 : f16
          }
          loom.semaphore_give %72 : memref<8x1x32x32xf16>
          linalg.fill ins(%cst : f16) outs(%21 : memref<1x32x128xf16>)
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>], iterator_types = ["reduction", "parallel", "parallel", "parallel"]} ins(%70 : memref<8x1x32x128xf16>) outs(%21 : memref<1x32x128xf16>) {
          ^bb0(%in: f16, %out: f16):
            %75 = arith.addf %in, %out : f16
            linalg.yield %75 : f16
          }
          loom.semaphore_give %70 : memref<8x1x32x128xf16>
          loom.sync ins(%21 : memref<1x32x128xf16>) outs(%27 : memref<1x32x128xf16>)
          loom.semaphore_give %21 : memref<1x32x128xf16>
          %reinterpret_cast_5 = memref.reinterpret_cast %arg2 to offset: [%24], sizes: [1, 32, 128], strides: [4096, 128, 1] : memref<8x32x128xf16> to memref<1x32x128xf16, strided<[4096, 128, 1], offset: ?>>
          loom.copy %27, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<1x32x128xf16> to memref<1x32x128xf16, strided<[4096, 128, 1], offset: ?>>
