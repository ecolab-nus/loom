...
module attributes {loom.tile_b = {is_reduction = false, upper_bound = 8 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}, loom.tile_s = {is_reduction = false, upper_bound = 4096 : index}} {
  func.func @_mqa_decode(%arg0: memref<8x128x4096xf16>, %arg1: memref<8x4096x128xf16>, %arg2: memref<8x32x128xf16>, %arg3: memref<8x32x128xf16>) {
    ...
    affine.parallel (%arg4, %arg5) = (0, 0) to (symbol(%3), symbol(%4)) {
      ...
      %subview = memref.subview %arg3[%10, 0, 0] [%0, 32, 128] [1, 1, 1] : memref<8x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
      ...
      scf.if %26 {
        ...
        %subview_3 = memref.subview %arg2[%10, 0, 0] [%0, 32, 128] [1, 1, 1] : memref<8x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
